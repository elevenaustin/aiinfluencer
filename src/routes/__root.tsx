...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "AI Influencer Class" },
      { property: "og:title", content: "AI Influencer Course — Create Viral AI Reels & Earn Lakhs" },
      {
        property: "og:description",
        content:
          "Build a hyper-realistic AI influencer, make viral reels and earn lakhs — all from your phone. Launch offer ₹149.",
      },
